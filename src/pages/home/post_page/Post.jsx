...
const Post = () => {
    ...
    const getTeacher = async (data) => {
        await settingService.getTeacherProfileById(data?.teacherId).then(teacher => {
        ...
        if (role){
            const isAlreadyAttending = await demoService.isStudentAttending(uuid);
    ...
    return (
        loading ? <Loading/> :
            <div className="Post">
                {switchToStudentView && <SwitchToLoginView close={() => setSwitchToStudentView(false)}/>}
                    ...
                    <div className="wrapper-first-part">
                        ...
                        <div className="post-days">
                            {data?.classDays?.map(day => {
                                return (
                                    <div className="post-day" key={day}>{day}</div>
                                )
                            })}
                        </div>
                        <div className="post-teacher-reviews">
                            <div className="post-teacher">
                                ...
                                <Link to={`/teacher/${teacher?.userName}`}>
                                    <img className="teacher-image" src={teacher?.profilePicture} alt="teacher-image"/>
                                </Link>
                            </div>
                        </div>
                    </div>
                    <div className="wrapper-second-part">
                        ...
                        <div className="post-info-price">
                            ...
                            <div className="parent-block">
                                {!isAlreadyAttending && (<div className="post-attend" onClick={handleAttendDemo}>
                                    Attend Demo
                                </div>)}
                            </div>
                        </div>
