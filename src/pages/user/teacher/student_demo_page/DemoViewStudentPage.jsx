...
const DemoViewStudentPage = () => {
    ...
    const renderStudentRow = (student) => {
        const isAccepted = acceptedStudents && acceptedStudents.includes(student?.studentId);
        ...
        return (
            <tr key={student?.studentId}>
                ...
                {!isAccepted && acceptStudents && <div className="accept-student"
                                                       onClick={() => handleAcceptStudent(student?.studentId)}>Accept</div>}
            </tr>
        );
    };
